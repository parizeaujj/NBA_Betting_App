...
class UserScreenInfoV2 {
    ...
    let continueWithButtonWidth: CGFloat!
    ...
    private init(){
        ...
        switch(screenSizeType){
            case .xsmall:
                ...
                self.continueWithButtonWidth = 250
            ...
            case .small:
                ...
                self.continueWithButtonWidth = 280
     ...
     static func getScreenSizeType() -> ScreenSizeType {
        ...
        let deviceName: String = UIDevice.current.name.trimmingCharacters(in: .whitespacesAndNewlines)
